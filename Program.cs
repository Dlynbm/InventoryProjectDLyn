...
namespace InventoryProjectDLyn
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            Inventory.PartStockPile.Add(new InHouse(1, "Wheel", 101, 12.99m, 150, 1, 100));
            Inventory.PartStockPile.Add(new InHouse(2, "Peddle", 102 , 15.99m, 130, 5, 100));
            Inventory.PartStockPile.Add(new Outsourced(3, "Chain", 10, 9.99m, 100, 10, "DM Designs"));
            Inventory.PartStockPile.Add(new Outsourced(4, "Seat", 104, 5.99m, 150, 100, "Shuman"));
